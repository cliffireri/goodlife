		...
		<div class="container mx-auto text-left text-white">
			<div class="lg:flex items-center">
				<div class="w-full lg:w-1/2">
                    ...
                    <p class="text-xl mb-12 text-gray-900">
                        Our mission is to provide solutions and
                        comfort to our customers. Our relevancy in the market has been mainly because of our quality,
